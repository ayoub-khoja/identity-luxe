...
export const translations = {
  ar: {
    ...
    shop: {
      ...
      collectionsTitle: "تصفحي مجموعاتنا",
      collectionsText: "أطقم الأطفال، هوديز الكبار، أطقم الكبار وحقائب التوت.",
    ...
    pack: {
      ...
      save: "وفّري 50 ر.ق",
      title: "باك العائلة",
      subtitle: "اختاري القطع وادفعي أقل",
      text: "مثال: قطعتان للأطفال والرضع + قطعتان للكبار. السعر 460 ر.ق يصبح 410 ر.ق — وفّري 50 ر.ق على الباك.",
      composition: "2 أطفال ورضع + 2 كبار",
      cta: "كوّني الباك",
      viewPacks: "كل عروض الباك",
      example: "مثال التوفير",
      was: "قبل",
      now: "سعر الباك",
      saveAmount: "التوفير",
      kids: "أطفال ورضع",
      adults: "كبار",
      tote: "حقائب",
      slotKids: "قطعة أطفال / رضع",
      slotAdults: "قطعة كبار",
      slotTote: "حقيبة توت",
      choose: "اختاري",
      change: "تغيير",
      offersTitle: "باقات لكل الفئات",
      familyName: "باك العائلة",
      familyDesc: "طفلان / رضيعان + قطعتان للكبار",
      kidsName: "باك الأطفال",
      kidsDesc: "قطعتان من أطقم الأطفال والرضع",
      adultsName: "باك الكبار",
      adultsDesc: "هوديز أو أطقم للكبار",
      completeName: "الباك الكامل",
      completeDesc: "أطفال + كبار + حقيبة توت",
      builderTitle: "كوّني باككِ",
      builderText: "اختاري المنتجات من كل الفئات. عند اكتمال الباك يُطبَّق خصم 50 ر.ق تلقائياً.",
      progress: "اختيري القطع",
      incomplete: "أكملي الباك لتفعيل الخصم",
      complete: "الباك مكتمل — الخصم مفعّل",
      orderWhatsapp: "اطلبي عبر واتساب",
      sizesNote: "المقاسات والألوان تُؤكَّد عبر واتساب.",
      emptyGroup: "لا توجد منتجات في هذه الفئة حالياً.",
    },
    onepage: {
      "#home": "الرئيسية",
      "#about": "الدار",
  ...
  en: {
    ...
    shop: {
      ...
      collectionsTitle: "Shop the collections",
      collectionsText: "Kids & babies sets, adult hoodies, adult sets and tote bags.",
    ...
    pack: {
      ...
      save: "Save 50 QAR",
      title: "Family Pack",
      subtitle: "Choose the pieces. Pay less.",
      text: "Example: 2 kids & baby pieces + 2 adult pieces. 460 QAR becomes 410 QAR — save 50 QAR on the pack.",
      composition: "2 kids & babies + 2 adults",
      cta: "Build your pack",
      viewPacks: "All pack offers",
      ...
      adults: "Adults",
      tote: "Tote bags",
      slotKids: "Kids / baby piece",
      slotAdults: "Adult piece",
      slotTote: "Tote bag",
      choose: "Choose",
      change: "Change",
      offersTitle: "Packs for every category",
      familyName: "Family Pack",
      familyDesc: "2 kids / babies + 2 adult pieces",
      kidsName: "Kids Pack",
      kidsDesc: "2 kids & baby sets",
      adultsName: "Adults Pack",
      adultsDesc: "Adult hoodies or sets",
      completeName: "Complete Pack",
      completeDesc: "Kids + adults + tote bag",
      builderTitle: "Build your pack",
      builderText: "Pick products from every category. Once the pack is complete, 50 QAR is taken off automatically.",
      progress: "Select the pieces",
      incomplete: "Complete the pack to unlock the discount",
      complete: "Pack complete — discount applied",
      orderWhatsapp: "Order on WhatsApp",
      sizesNote: "Sizes and colors are confirmed on WhatsApp.",
      emptyGroup: "No products in this category yet.",
    },
    onepage: {
      "#home": "Home",
      "#about": "Maison",
